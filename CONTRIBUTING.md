...
- **Branches:** branches should be named in imperative, present tense with a clear object. e.g. `fix-auth-type-error` or `revert-type-changes`
...
- Title your issues in a way that describes your problem in one line
